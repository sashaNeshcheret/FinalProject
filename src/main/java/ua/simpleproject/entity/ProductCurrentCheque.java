...
public class ProductCurrentCheque {
    ...
    public ProductCurrentCheque() {
    }

    public ProductCurrentCheque(String nameProduct, int codeProduct, BigDecimal numberOfProduct,
                                BigDecimal priceForOne, BigDecimal resultPrice) {
