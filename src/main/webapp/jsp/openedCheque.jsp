...
<table width="80%" border="2" cellpadding="7" cellspacing="0" align="center">
    <tr colspan="2"  valign="top" align="center">
        <td width="55%">${productCurrentCheck.nameProduct}</td>
        <td width="15%">${productCurrentCheck.numberOfProduct}</td>
        <td width="15%">${productCurrentCheck.priceForOne}</td>
        <td width="15%">${productCurrentCheck.resultPrice}</td>
    </tr>
</table>-->
